...
namespace MDEN.Managers
{
    public static class I18nManager
    {
        ...
        private static void RegisterAll()
        {
            ...
            Register("chat.player_hidden_chart", "隐藏了 {0} 谱面", "has hidden chart {0}", "隱藏了 {0} 譜面", "{0} の譜面を非表示にしています", "{0} 채보를 숨겼습니다");
            ...
            Register("chat.ap.just_tp", "刚刚TP了", " just TPed ", "剛剛 TP 了", "が TP しました：", " 방금 TP를 달성했습니다: ");
            ...
            Register("chat.guide.entry", "点击此处查看聊天说明！", "Click here for chat help!", "點擊此處查看聊天說明！", "ここをクリックしてチャット説明を表示！", "여기를 눌러 채팅 안내를 확인하세요!");
            Register("chat.guide.title", "聊天说明", "Chat Help", "聊天說明", "チャット説明", "채팅 안내");
            Register("chat.guide.body", "<color=#ffd966ff>欢迎来到Ensemble</color>，你现在可以和当前服务器节点的所有玩家进行交流了！\n\n你可以直接在聊天框发送信息，所有<color=#ffd966ff>未屏蔽世界频道</color>的玩家都可以看见你的消息OVO\n\n你也可以点击房间内其他人发送的<color=#66ff66ff>邀请播报</color>来快速加入其他人的房间！\n\n进入房间之后，在聊天框按 <color=#ffd966ff>Tab</color> 按键可以切换三种聊天模式，分别是：<color=#66ff66ff>房间</color>、<color=#ffd966ff>世界</color>、<color=#f542adff>邀请</color>。可以自由发送你想发送的信息！\n\n不过请注意，不愉快的发言，例如辱骂、讨论政治、侮辱他人等冒犯的语言都会受到监管，会受到严重的处罚甚至封号！所以请友善地与他人交流哦~\n\n<color=#66ff66ff>祝您游戏愉快！</color>", "<color=#ffd966ff>Welcome to Ensemble</color>. You can now chat with every player on the current server node!\n\nSend a message directly in the chat box, and every player who has <color=#ffd966ff>not hidden the World channel</color> can see it OVO\n\nYou can also click <color=#66ff66ff>invite broadcasts</color> sent by players in rooms to quickly join their rooms!\n\nAfter entering a room, press <color=#ffd966ff>Tab</color> in the chat box to switch between three chat modes: <color=#66ff66ff>Room</color>, <color=#ffd966ff>World</color>, and <color=#f542adff>Invite</color>. Send whatever you want to say!\n\nPlease note that unpleasant messages, such as insults, political discussion, personal attacks, or other offensive language, are moderated and may result in severe penalties or even account bans. Please be kind to others~\n\n<color=#66ff66ff>Have fun!</color>", "<color=#ffd966ff>歡迎來到 Ensemble</color>，你現在可以和目前伺服器節點的所有玩家交流了！\n\n你可以直接在聊天框發送訊息，所有<color=#ffd966ff>未屏蔽世界頻道</color>的玩家都可以看見你的訊息 OVO\n\n你也可以點擊房間內其他人發送的<color=#66ff66ff>邀請播報</color>，快速加入其他人的房間！\n\n進入房間之後，在聊天框按 <color=#ffd966ff>Tab</color> 可以切換三種聊天模式，分別是：<color=#66ff66ff>房間</color>、<color=#ffd966ff>世界</color>、<color=#f542adff>邀請</color>。可以自由發送你想說的內容！\n\n不過請注意，不愉快的發言，例如辱罵、討論政治、侮辱他人等冒犯性語言都會受到監管，可能受到嚴重處罰甚至封號！所以請友善地與他人交流喔~\n\n<color=#66ff66ff>祝您遊戲愉快！</color>", "<color=#ffd966ff>Ensembleへようこそ</color>。現在のサーバーノードにいる全プレイヤーと交流できます！\n\nチャット欄に直接メッセージを送ると、<color=#ffd966ff>ワールドチャンネルを非表示にしていない</color>全プレイヤーに表示されます OVO\n\nルーム内のほかのプレイヤーが送った<color=#66ff66ff>招待のお知らせ</color>をクリックすると、そのルームにすばやく参加できます！\n\nルームに入った後、チャット欄で <color=#ffd966ff>Tab</color> を押すと、<color=#66ff66ff>ルーム</color>、<color=#ffd966ff>ワールド</color>、<color=#f542adff>招待</color> の3つの送信モードを切り替えられます。送りたい内容を自由に送信できます！\n\nただし、暴言、政治的な話題、他人への侮辱など不快な発言は監視対象となり、重い処罰やアカウント停止につながる場合があります。みんなにやさしく交流してくださいね~\n\n<color=#66ff66ff>楽しいゲームを！</color>", "<color=#ffd966ff>Ensemble에 오신 것을 환영합니다</color>. 이제 현재 서버 노드의 모든 플레이어와 대화할 수 있습니다!\n\n채팅창에 바로 메시지를 보내면 <color=#ffd966ff>월드 채널을 숨기지 않은</color> 모든 플레이어가 볼 수 있습니다 OVO\n\n방 안의 다른 플레이어가 보낸 <color=#66ff66ff>초대 알림</color>을 클릭해 다른 사람의 방에 빠르게 참가할 수도 있습니다!\n\n방에 들어간 뒤 채팅창에서 <color=#ffd966ff>Tab</color> 키를 누르면 <color=#66ff66ff>방</color>, <color=#ffd966ff>월드</color>, <color=#f542adff>초대</color> 세 가지 채팅 모드를 바꿀 수 있습니다. 보내고 싶은 메시지를 자유롭게 보내세요!\n\n다만 욕설, 정치 이야기, 타인 모욕 등 불쾌한 발언은 관리 대상이며 심각한 제재나 계정 정지까지 받을 수 있습니다. 서로 친절하게 대화해 주세요~\n\n<color=#66ff66ff>즐거운 게임 되세요!</color>");
            Register("chat.guide.node_players", "点击<color=#ffd966ff>经验条右边的节点按键</color>可以查看和邀请当前节点在线的玩家。", "Click the <color=#ffd966ff>node button to the right of the EXP bar</color> to view and invite online players on the current node.", "點擊<color=#ffd966ff>經驗條右邊的節點按鍵</color>可以查看並邀請目前節點在線的玩家。", "<color=#ffd966ff>経験値バー右側のノードボタン</color>を押すと、現在のノードにいるオンラインプレイヤーを確認して招待できます。", "<color=#ffd966ff>경험치 바 오른쪽의 노드 버튼</color>을 누르면 현재 노드의 온라인 플레이어를 확인하고 초대할 수 있습니다.");
