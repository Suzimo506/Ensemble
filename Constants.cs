namespace MDEN
{
    ...
    {
        public const string ColorBlue = "4564ffff";
        ...
        public const string CreditsText = "当前Ensemble版本：<color=" + ColorGreen + ">0.4.0</color>\n" +
            ...
            "[ 测试团队 ]\n" +
            "MSC☆言叶. AP的是给 浅夏 莼畹ChunWan_ Tvv 冬瓜糖 飞翔冥王星 晓屿云叙 GreenHub 纯鹿人 苏达 nuxwalker 萧千岁 fish 姫坂乃愛\n" +
            "[ 特别感谢 ]\n" +
            "<color=" + ColorLavender + ">莼畹ChunWan_</color> — 宣传大使\n" +
